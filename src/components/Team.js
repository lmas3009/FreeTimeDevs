...
class Team extends React.Component{
    ...
    {
        return(
            <section class="text-gray-500 bg-gray-900 body-font" id="team">
    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-white">Sumanth.B</h2>
            <h3 class="text-gray-600 mb-3">Web &amp; App Developer</h3>
            <p class="mb-4"></p>
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-white">Aravind Kumar.V</h2>
            <h3 class="text-gray-600 mb-3">Web &amp; App Developer</h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-700">
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-white">Sai Hruthik.B</h2>
            <h3 class="text-gray-600 mb-3">Web &amp; App Developer</h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-700">
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          ...
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-white">Pramod Kumar</h2>
            <h3 class="text-gray-600 mb-3">AI Web Developer</h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-700">
                <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
      ...
      <div class="p-4 lg:w-1/2">
        <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
          <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="https://dummyimage.com/204x204"/>
          <div class="flex-grow sm:pl-8">
            <h2 class="title-font font-medium text-lg text-white">Sai Chinmay.T</h2>
            <h3 class="text-gray-600 mb-3">Web &amp; App Developer</h3>
            <p class="mb-4"></p>
            <span class="inline-flex">
              <a class="text-gray-700">
